...
x_spl = img.x_spl
y_spl = img.y_spl
length_pixels = img.length_pixels
...
xFT = FourierApprox(x_spl, (0, length_pixels), num_points=num_points, N=num_circles)
yFT = FourierApprox(y_spl, (0, length_pixels), num_points=num_points, N=num_circles)
